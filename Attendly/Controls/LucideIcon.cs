...
internal static class LucideIconData
{
    public static readonly IReadOnlyDictionary<LucideIconKind, string> PathData = new Dictionary<LucideIconKind, string>
    {
        ...
        [LucideIconKind.WifiOff] = "M12 20h.01 M8.5 16.429a5 5 0 017 0 M5 12.859a10 10 0 015.17-2.69 M19 12.859a10 10 0 00-2.007-1.523 M2 8.82a15 15 0 014.177-2.643 M22 8.82A15 15 0 0010.712 5.056 M3 0l20 20",
        ...
        [LucideIconKind.Eye] = "M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0 M9.0,12.0 a3.0,3.0 0 1,0 6.0,0 a3.0,3.0 0 1,0 -6.0,0",
    };
}